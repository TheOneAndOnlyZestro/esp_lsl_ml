...
class MicroMutableOpResolver : public MicroOpResolver {
 public:
  ...
  //OUR CUSTOM RESOLVER
  TfLiteStatus AddSelect(const TFLMRegistration& registration = Register_SELECT_V2()) {

        // Register V2's kernel under the legacy SELECT opcode (64)
        return AddBuiltin(
            tflite::BuiltinOperator_SELECT,         // opcode 64
            tflite::Register_SELECT_V2(),           // V2's kernel
            tflite::ParseSelectV2                   // V2's parser
        );
    }
